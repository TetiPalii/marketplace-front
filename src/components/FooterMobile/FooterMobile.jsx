  ...
  return (
    <div className=" md:h-910 md:w-352 px-60  pt-16  pb-14 bg-darkBlue ">
      <div className="flex-basis: 20rem gap-y-12">
        <ul className="text-[#FFF] text-base list-none mb-12">
      ...
      <div className="flex-basis: 14rem">
        <ul className="text-[#FFF] text-base list-none mb-12 border-b-indigo-500">
          Допомога
        </ul>
        <li className="text-[#FFF] text-xs list-none mb-12">
      ...
      <div className="flex-basis: 14rem">
        <ul className="text-[#FFF] text-base list-none list-none mb-12">
          Партнерам
        </ul>
        <li className="text-[#FFF] text-xs list-none mb-12">
      ...
      <div className="flex justify-between">
        <div className="w-298 h-118">
          <h2 className="text-[#656E81] text-xs mb-7">
        ...
        <div>
          <button type="button" className="text-[#fff] text-base">
            Вийти із аккаунта
          </button>
        </div>
      </div>
